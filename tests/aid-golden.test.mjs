...
const E={
 standard:{
  ...
  tandem:{fastLow:["Minska relevant basal ≈10–20 %","Om korrektionsdriven: försvaga ISF ≈10–20 %"],fastHigh:["Öka relevant basal ≈10–20 %","Vid kvarstående hyperglykemi/otillräckliga autokorrektioner: stärk ISF ≈10–20 %"],mealHighTransient:[],mealHighPersistent:["Stärk KH-kvot ≈10–20 %"],lateHigh:["Stärk KH-kvot ≈10–20 %","Förlängd bolus vb"],mealLow:["Försvaga KH-kvot ≈10–20 %"],exerciseLow:["Starta \"Träning\" 1–2 h före aktivitet som brukar sänka glukos"]},
